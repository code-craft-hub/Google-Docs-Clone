  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className={cn(
            "h-7 w-7 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80"
          )}
        >
...
const FontSizeButton = () => {
  ...
  return (
    <div className="flex items-center gap-x-0.5">
      <button
        className="h-7 w-7 flex items-center justify-center rounded-sm hover:bg-neutral-200/80 text-sm px-1.5 overflow-hidden"
        onClick={decrement}
      >
  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent className="p-2.5 flex items-center gap-x-2">
        <Input
          placeholder="https://codecrafthub.site"
          value={value}
